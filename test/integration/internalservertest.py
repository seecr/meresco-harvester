...
class InternalServerTest(IntegrationTestCase):
    ...
    def testListInvalidRecordsForOneRepository(self):
        ...
        self.assertEqual(['oai:record:08', 'oai:record:07', 'oai:record:05', 'oai:record:04', 'oai:record:02/&gkn', 'oai:record:01'], result.xpath("/div/table/tr/td[@class='link']/a/text()"))
        self.assertEqual("/page/invalidRecord/?recordId=oai%3Arecord%3A08&domainId=adomain&repositoryId=integrationtest", result.xpath("/div/table/tr/td[@class='link']/a")[0].attrib['href'])
        self.assertEqual("/page/showHarvesterStatus/show?domainId=adomain&repositoryId=integrationtest", result.xpath("/div/p/a/@href")[0])
    ...
    def testViewInvalidRecordWithoutDetails(self):
        ...
        self.assertEqual("/page/invalid/?domainId=adomain&repositoryId=integrationtest", result.xpath("/div/p/a/@href")[0])
        self.assertEqual(["No error message."], result.xpath("/div/pre/text()"))
    ...
    def testViewInvalidRecord(self):
        ...
        self.assertEqual("/page/invalid/?domainId=adomain&repositoryId=integrationtest", result.xpath("/div/p/a/@href")[0])
        self.assertEqual(["Invalid data"], result.xpath("/div/pre/text()"))
